...
public class newTangentFollower : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        ...
        if (Physics.Raycast(ray, out hit, 50) == true)
        {
            ...
            posCur = new Vector3(transform.position.x, hit.point.y+0.2f, transform.position.z);
        ...
        if (grounded == true)
        {
            ...
            //rigidb.AddRelativeForce(new Vector3(thrust,0, 0));
